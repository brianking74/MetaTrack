          ...
          currentAssessment ? (
            showFullReport ? (
              <div className="animate-in fade-in duration-500 pb-20">
                <button onClick={() => setShowFullReport(false)} className="mb-6 text-sm font-bold text-brand-600 hover:underline flex items-center gap-1">
              ...
              <div className="bg-white p-16 rounded-[2.5rem] shadow-2xl text-center border border-slate-100 max-w-2xl mx-auto animate-in fade-in zoom-in duration-500">
                ...
                <div className="p-10 bg-brand-50 border-2 border-brand-100 rounded-[2rem] inline-block shadow-inner mb-10">
                  ...
                  <span className="text-4xl font-black text-brand-900">{currentAssessment.overallPerformance.managerRating || "Pending"}</span>
                </div>
